...
def generateCircle(P1, P2, P3, T):
  ...
  while (i<=number_of_points):
    pz = pc + (p1-pc)*cos((pi*i/number_of_points)/r) + cross(n, p1-pc) * sin((pi*i/number_of_points)/r)
...
P1 = Pose(Point(0.705438961242, -0.1208864692291, 1.181029263241), Quaternion(0.675351045979, 0.0892025112399, 0.698321120995, 0.219753244928))
P2 = Pose(Point(0.805438961242, 0.0, 1.181029263241), Quaternion(0.675351045979, 0.0892025112399, 0.698321120995, 0.219753244928))
P3 = Pose(Point(0.705438961242, 0.1208864692291, 1.181029263241), Quaternion(0.675351045979, 0.0892025112399, 0.698321120995, 0.219753244928))
